...
BOT_NAME = getenv("BOT_NAME", "Royal Music")
...
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "MR_ROYAL_SUPPORT")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "ELINABOTS")
OWNER_NAME = getenv("OWNER_NAME", "PARVSHAH_01") # isi dengan username kamu tanpa simbol @
